...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const depositRequiredCheckbox = document.getElementById('deposit_required');
        ...
        depositRequiredCheckbox.addEventListener('change', function() {
            if (this.checked) {
                depositDetailsSection.classList.remove('d-none');
            } else {
                depositDetailsSection.classList.add('d-none');
            }
        });
    });
</script>
