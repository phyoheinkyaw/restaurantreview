...
require_once 'includes/currency.php'; // Add currency utilities
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a
                                href="restaurant.php?id=<?php echo $restaurant_id; ?>"><?php echo htmlspecialchars($restaurant['name']); ?></a>
                        </li>
                    ...
                    <div class="card-body">
                        <form method="POST" action="" enctype="multipart/form-data" id="reservationForm">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="party_size" name="party_size" required>
                                    ...
                                    <option value="<?php echo $i; ?>"><?php echo $i; ?>
                                        <?php echo $i === 1 ? 'person' : 'people'; ?></option>
                                    <?php endfor; ?>
                                </select>
                            </div>
                            ...
                            <div class="alert alert-info mb-3">
                                ...
                                <p>This restaurant requires a deposit of
                                    $<?php echo number_format($restaurant['deposit_amount'], 2); ?> to secure your
                                    reservation.</p>
                                ...
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        <p class="mb-1"><strong>Bank:</strong>
                                            <?php echo htmlspecialchars($restaurant['deposit_bank_name']); ?></p>
                                        <p class="mb-1"><strong>Account Name:</strong>
                                            <?php echo htmlspecialchars($restaurant['deposit_account_name']); ?></p>
                                        <p class="mb-1"><strong>Account Number:</strong>
                                            <?php echo htmlspecialchars($restaurant['deposit_account_number']); ?></p>
                                        <?php if (!empty($restaurant['deposit_payment_instructions'])): ?>
                                        <p class="mt-2"><strong>Instructions:</strong>
                                            <?php echo nl2br(htmlspecialchars($restaurant['deposit_payment_instructions'])); ?>
                                        </p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        <ol class="mb-0">
                                            <li class="mb-2">Make a payment of
                                                $<?php echo number_format($restaurant['deposit_amount'], 2); ?> to the
                                                account listed above.</li>
                                            <li class="mb-2">Take a screenshot or photo of your payment confirmation.
                                            </li>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control" id="deposit_payment_slip"
                                        name="deposit_payment_slip" accept="image/jpeg,image/png,image/jpg" required>
                                    <div class="form-text">
                                        Please upload a screenshot or photo of your deposit payment slip. Accepted
                                    ...
                                    <div id="slip-preview-container" class="mt-3 text-center d-none">
                                        <div class="card">
                                            <div class="card-header d-flex justify-content-between align-items-center">
                                                ...
                                                <button type="button" class="btn-close" id="clear-preview"
                                                    aria-label="Close"></button>
                                            </div>
                                            <div class="card-body">
                                                <img id="slip-preview" src="#" alt="Payment Slip Preview"
                            ...
                            <div class="mt-4">
                                ...
                                <a href="restaurant.php?id=<?php echo $restaurant_id; ?>"
                ...
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <img src="<?php echo htmlspecialchars($restaurant['image']); ?>"
                            alt="<?php echo htmlspecialchars($restaurant['name']); ?>" class="img-fluid rounded mb-3">
                        <?php endif; ?>

                        <div class="mb-3">
                            <p class="mb-1"><i
                                    class="fas fa-map-marker-alt me-2 text-primary"></i><?php echo htmlspecialchars($restaurant['address']); ?>
                            </p>
                            <p class="mb-1"><i
                                    class="fas fa-phone me-2 text-primary"></i><?php echo htmlspecialchars($restaurant['phone']); ?>
                            </p>
                            <p class="mb-1"><i
                                    class="fas fa-utensils me-2 text-primary"></i><?php echo htmlspecialchars($restaurant['cuisine_type']); ?>
                            </p>
                            <p class="mb-1"><i class="fas fa-tag me-2 text-primary"></i>Price Range:
                                <?php echo htmlspecialchars($restaurant['price_range']); ?></p>
                        </div>
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <ul class="list-unstyled">
                            <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i>Please arrive on time
                            </li>
                            <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i>If you're running
                                late, please call the restaurant</li>
                            <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i>Cancellations should
                                be made at least 24 hours in advance</li>
                            <?php if ($restaurant['deposit_required']): ?>
                            <li class="mb-2"><i class="fas fa-exclamation-circle text-warning me-2"></i>Deposit is
                                required to confirm reservation</li>
                            <li class="mb-2"><i class="fas fa-exclamation-circle text-warning me-2"></i>Deposit will be
                                deducted from your final bill</li>
                            <?php endif; ?>
                        </ul>
                    </div>
                </div>
        ...
        flatpickr("#reservation_date", {
            ...
            onChange: function(selectedDates, dateStr) {
                ...
                if (dateStr) {
                    ...
                    fetch(
                            `get_timeslots.php?restaurant_id=<?php echo $restaurant_id; ?>&date=${dateStr}`)
                        ...
                        .catch(error => {
                            ...
                            timeSelect.innerHTML =
                                '<option value="">Error loading time slots. Please try again.</option>';
                            timeSelect.disabled = false;
                        });
                }
            }
