...
<section class="restaurant-content py-5">
    <div class="container">
        ...
        <div class="alert alert-success alert-dismissible fade show mb-4" role="alert">
            <i class="fas fa-check-circle me-2"></i> Your reservation has been successfully made! You can view it in
            your <a href="reservations.php" class="alert-link">reservations page</a>.
                        ...
                        <div class="col-md-4">
                            <div class="row g-3">
                                <div class="col-6 col-md-12">
                                    <img src="https://placehold.co/600x400/2dc2a3/333333?text=Restaurant+Interior"
                                        class="img-fluid rounded" alt="Restaurant Interior">
                                </div>
                                <div class="col-6 col-md-12">
                                    <img src="https://placehold.co/600x400/2dc2a3/333333?text=Restaurant+Food"
                                        class="img-fluid rounded" alt="Restaurant Food">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="restaurant-info mb-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text"><?php echo nl2br(htmlspecialchars($restaurant['description'])); ?>
                            </p>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6">
                                    ...
                                    <p><i
                                            class="fas fa-map-marker-alt me-2"></i><?php echo htmlspecialchars($restaurant['address']); ?>
                                    </p>
                                    <p><i
                                            class="fas fa-phone me-2"></i><?php echo htmlspecialchars($restaurant['phone']); ?>
                                    </p>
                                    <p><i
                                            class="fas fa-envelope me-2"></i><?php echo htmlspecialchars($restaurant['email']); ?>
                                    </p>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="card h-100 menu-item-card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start">
                                        ...
                                        <span class="price badge bg-light text-dark fs-6" data-price-usd="<?php echo $item['price']; ?>">
                                            ...
                                            <div class="rating-input">
                                                <div class="stars">
                                                    ...
                                                    <input type="radio" id="<?php echo $key; ?>_<?php echo $i; ?>"
                                                        name="<?php echo $key; ?>_rating" value="<?php echo $i; ?>"
                                                        required>
                    ...
                    <div class="write-review-section mb-4">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <p class="card-text">Please <a href="login.php">login</a> to share your experience.
                                </p>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="similar-restaurant-content">
                                            ...
                                            <div class="d-flex align-items-center mb-2">
                                                <span class="cuisine-badge me-2">
                                                    ...
                                                    <?php echo htmlspecialchars($similar['cuisine_type'] ?? 'Unknown'); ?>
                                                </span>
                                                <span class="price-badge">
                                                    <i class="fas fa-dollar-sign"></i>
                                                    <?php echo htmlspecialchars($similar['price_range'] ?? 'N/A'); ?>
                                                </span>
                                            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    var map = L.map('map').setView([<?php echo $restaurant['latitude']; ?>,
        <?php echo $restaurant['longitude']; ?>
    ], 15);
    ...
    document.querySelectorAll('.rating-input').forEach(input => {
        ...
        stars.forEach(star => {
            star.addEventListener('change', function() {
                ...
                const categoryText = category.charAt(0).toUpperCase() + category
                    .slice(1);
                ...
                fetch('process_review.php', {
                    ...
                    .then(data => {
                        ...
                        if (data.success) {
                            ...
                            if (fileInput) {
                                fileInput.previousElementSibling.innerHTML =
                                    '<i class="fas fa-camera"></i> Add Photos';
                                fileInput.previousElementSibling.classList.remove(
                                'btn-primary');
                                fileInput.previousElementSibling.classList.add(
                                    'btn-outline-primary');
                            }
                            // Reset rating texts
